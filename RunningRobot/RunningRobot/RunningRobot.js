...
function initSceneNodes(Id) {
    ...
    switch (Id) {
        ...
        case columnId3:
            ...
            scene[columnId3] = createNode(m, column, columnId4, null, brown, grayish, 1, null);
            break;

        case columnId4:
            m = translate(colPosArray[columnId4]);
            scene[columnId4] = createNode(m, column, columnId5, null, brown, grayish, 2, null);
            break;
        ...
        case columnId6:
            ...
            scene[columnId6] = createNode(m, column, columnId7, null, brown, grayish, 1, null);
            break;

        case columnId7:
            m = translate(colPosArray[columnId7]);
            scene[columnId7] = createNode(m, column, columnId8, null, brown, grayish, 2, null);
            break;
        ...
        case columnId9:
            ...
            scene[columnId9] = createNode(m, column, columnId10, null, brown, grayish, 2, null);
            break;
